...
# Verify JSON
with open("ner_lower.json", "r") as f:
    data = json.load(f)
...
dataset = load_dataset("json", data_files="ner_lower.json", split="train")
...
# Train and save
trainer.train()
model.save_pretrained("./fine_tuned_lower_case")
tokenizer.save_pretrained("./fine_tuned_lower_case")
